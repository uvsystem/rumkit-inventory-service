package com.dbsys.rs.inventory;
...
@EnableJpaRepositories(basePackages = {
	"com.dbsys.rs.inventory.repository",
	"com.dbsys.rs.security.repository"
})
@EnableAspectJAutoProxy
@EnableTransactionManagement
@ComponentScan({
	"com.dbsys.rs.inventory.service",
...
public class ApplicationConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
    	...
    	entityManagerFactoryBean.setPackagesToScan("com.dbsys.rs.inventory.entity", "com.dbsys.rs.security.entity");
